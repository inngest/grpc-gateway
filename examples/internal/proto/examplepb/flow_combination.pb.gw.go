...
var filter_FlowCombination_RpcBodyRpc_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int{1, 0}, Check: []int{0, 1}}
...
var filter_FlowCombination_RpcBodyStream_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int{1, 0}, Check: []int{0, 1}}
